    ...
    <xsl:choose>
      <xsl:when test="active-surfer">
        <ul class="nav pull-right">
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{active-surfer/@avatar}" alt="" /> <xsl:value-of select="active-surfer/@name" /> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="{active-surfer/page-link}">Profile</a></li>
              ...
              <xsl:if test="active-surfer/contacts-link or active-surfer/contact-requests-link or active-surfer/contact-own-requests-link">
                ...
                <xsl:if test="active-surfer/contacts-link">
                 <a href="{active-surfer/contacts-link}"><xsl:value-of select="active-surfer/contacts-link/@caption" /></a>
                </xsl:if>
                <xsl:if test="active-surfer/contact-own-requests-link">
                 <a href="{active-surfer/contact-own-requests-link}"><xsl:value-of select="active-surfer/contact-own-requests-link/@caption" /></a>
                </xsl:if>
                <xsl:if test="active-surfer/contact-requests-link">
                 <a href="{active-surfer/contact-requests-link}"><xsl:value-of select="active-surfer/contact-requests-link/@caption" /></a>
                </xsl:if>
              </xsl:if>
